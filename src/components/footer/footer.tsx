            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0 flex flex-col items-center justify-center">
                        <Link href="/" className="flex justify-center lg:justify-start">
                            <Image src='/assets/logo.png' width={80} height={80} className='w-[70px] pb-0.5 !h-[40px]' alt='logo' />
                        </Link>
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">CapsCode</a> 2024, All rights reserved.</span>
