...
export default function Navbar() {
    return (
        <div id='topOfPage' className='flex z-[1000] flex-col bg-black bg-opacity-45 gap-2 mx-auto justify-center items-center'>
            <div className='container flex gap-3 md:gap-0 flex-row items-center mx-auto px-8 lg:px-0 justify-between h-[70px]'>
                <Link href='/' className=''>
                    <Image src='/assets/logo.png' width={80} height={50} className='w-[45px] h-[30px] lg:w-[60px] !lg:h-[40px]' alt='logo' />
                </Link>
            ...
            <div className='md:flex flex lg:hidden flex-row items-center justify-evenly mx-auto -ms-1 w-full'>
                <MagneticComponent >
